  ...
  function getLayout() {
    ...
    if (currentCategoryLayout === "grid") {
      DUMMY_DATA.forEach((item, index) => {
        content += `
          <div class="post-card -center"><a class="card__cover" href="{% url 'post' %}"><img src="${item.image}" alt="${item.title}"></a>
            <div class="card__content">
            <h5 class="card__content-category">${item.category}</h5><a class="card__content-title" href="{% url 'post' %}">${item.title}</a>
      ...
      DUMMY_DATA.forEach((item, index) => {
        ...
        <div class="col-12">
          <div class="post-card -small -horizontal">
            <a class="card__cover" href="{% url 'post' %}" tabindex="0"><img src="${item.image}" alt="${item.title}"></a>
            <div class="card__content">
              <h5 class="card__content-category">Web Development</h5>
                <a class="card__content-title" href="{% url 'post' %}" tabindex="0">${item.title}</a>
              <div class="card__content-info">
                <div class="info__time"><i class="far fa-clock"></i>
